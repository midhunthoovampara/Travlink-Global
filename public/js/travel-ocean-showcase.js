(function () {
  ...
  function initialiseOceanShowcases() {
    ...
    document.querySelectorAll("[data-ocean-showcase]").forEach(function (showcase) {
      ...
      var cards = Array.from(showcase.querySelectorAll("[data-ocean-card]"));
      var navButtons = Array.from(showcase.querySelectorAll("[data-ocean-nav]"));
      var viewport = showcase.querySelector("[data-ocean-viewport]");
      var activeIndex = 0;
      var scrollFrame = 0;
